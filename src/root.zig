//! pi-zig library root: full coding agent modules + monorepo-scale surface packages.
...
// Monorepo package surfaces (native Zig)
...
pub const llama = @import("llama/root.zig");
